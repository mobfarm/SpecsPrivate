#
#  Be sure to run `pod spec lint MFCommons.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/mobfarm/MFCommons"
  ...
  s.source       = { :git => "https://github.com/mobfarm/MFCommons.git", :tag => "0.1.0" }
